...
import 'package:login_signup/common/textfilde.dart';
import 'package:login_signup/sign_up_screen_stackbar.dart';

class LoginScreenStackbar extends StatefulWidget {
  const LoginScreenStackbar({Key? key}) : super(key: key);

  @override
  State<LoginScreenStackbar> createState() => _LoginScreenStackbarState();
}

class _LoginScreenStackbarState extends State<LoginScreenStackbar> {
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (context) => const SignUpScreenStackbar(),
                        ),
                      );
                    },
                    child: Container(
